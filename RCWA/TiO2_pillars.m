...
res = 100;
input.diameter_range = linspace(0.05e-6, 0.35e-6, res);
input.lambda_range = 0.532e-6; % [m] 3.5 um
input.lambda0 = 0.532e-6; % [m] 3.5 um
input.debug = false;
...
subplot(1,2,1);
plot(input.diameter_range*1e6,phase(1:res));
...
subplot(1,2,2);
plot(input.diameter_range*1e6,transmission(1:res).^2);
