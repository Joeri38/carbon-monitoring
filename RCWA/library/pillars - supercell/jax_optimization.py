...
# Load neural network
model_1 = tf.keras.models.load_model(path + 'neural networks/supercell_2_holes_lamb_0.76_epochs=5000_res128.hdf5')
model_1_jax = jax2tf.call_tf(model_1)
model_2 = tf.keras.models.load_model(path + 'neural networks/supercell_2_holes_lamb_1.61_epochs=5000.hdf5')
model_2_jax = jax2tf.call_tf(model_2)
model_3 = tf.keras.models.load_model(path + 'neural networks/supercell_2_holes_lamb_2.06_epochs=5000.hdf5')
model_3_jax = jax2tf.call_tf(model_3)
model_4 = tf.keras.models.load_model(path + 'neural networks/supercell_2_holes_lamb_4.8_epochs=1000.hdf5')
